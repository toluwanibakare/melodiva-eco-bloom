...
VALUES 
  ...
  ('social_media', '1. Reactivate & Optimize Official Social Media Channels', 'Re-establish and configure accounts, bio links, tracking pixels, profile graphics, and business profiles for Facebook, Instagram, and TikTok.', 'Phase 1: Setup', 'todo', 'TMB', CURRENT_DATE + INTERVAL '5 days', 1),
  ('social_media', '2. Formulate 60-Day Content Strategy & Editorial Calendar', 'Formulate overarching content strategy, weekly theme pillars, educational topics, and 60-day posting calendar to guide Favor.', 'Phase 1: Setup', 'todo', 'TMB', CURRENT_DATE + INTERVAL '10 days', 2),
  ('social_media', '3. Design Social Media Graphic Templates & Branding Assets', 'Create reusable Canva/Photoshop graphics, story templates, carousel slides, and reel covers based on TMB strategy guidelines.', 'Phase 1: Setup', 'todo', 'Favor', CURRENT_DATE + INTERVAL '14 days', 3),
  ('social_media', '4. Configure WhatsApp Business Quick Replies & Link-in-Bio', 'Set up Linktree/bio page connecting website shop, WhatsApp order chat, affiliate registration, and customer FAQs.', 'Phase 1: Setup', 'todo', 'TMB', CURRENT_DATE + INTERVAL '14 days', 4),

  -- PHASE 2: BRAND STORY & AFFILIATE LAUNCH (Weeks 3 - 4)
  ('social_media', '5. Publish Melodiva Brand Story & Ingredients Series', 'Schedule and post introductory brand series highlighting Melodiva inception (Nov 2023), natural African Black Soap heritage, and Kernel Oil benefits.', 'Phase 2: Launch', 'todo', 'Favor', CURRENT_DATE + INTERVAL '21 days', 5),
  ('social_media', '6. Kickstart Affiliate Marketing Campaign Strategy & Collateral', 'Design campaign structure, commission rate promotions (10%), and affiliate onboarding collateral to recruit micro-influencers and ambassadors.', 'Phase 2: Launch', 'todo', 'TMB', CURRENT_DATE + INTERVAL '25 days', 6),
  ('social_media', '7. Launch Affiliate Recruitment Posts & DM Outreach', 'Publish promotional posts and stories inviting beauty creators to join the Melodiva affiliate program with unique tracking links.', 'Phase 2: Launch', 'todo', 'Favor', CURRENT_DATE + INTERVAL '28 days', 7),

  -- PHASE 3: PRODUCT SPOTLIGHTS & SOCIAL PROOF (Weeks 5 - 6)
  ('social_media', '8. Roll Out Black Soap & Kernel Oil Product Spotlights', 'Publish weekly product highlight videos and carousels showcasing Black Soap (Exquisite, Perfume, Natural) and Kernel Oil (250ml, 500ml, 1000ml).', 'Phase 3: Spotlights', 'todo', 'Favor', CURRENT_DATE + INTERVAL '35 days', 8),
  ('social_media', '9. Launch Customer Testimonials & Before/After UGC Series', 'Share genuine customer reviews, video unboxings, and skin transformation stories with purchase call-to-actions.', 'Phase 3: Spotlights', 'todo', 'Favor', CURRENT_DATE + INTERVAL '42 days', 9),

  -- PHASE 4: SALES PUSH, GIVEAWAYS & FINAL REVIEW (Weeks 7 - 8)
  ('social_media', '10. Host 2-Month Campaign Anniversary Giveaway', 'Host interactive Instagram/TikTok giveaway encouraging tags, shares, and website cart visits to boost engagement and follower growth.', 'Phase 4: Sales Push', 'todo', 'Favor', CURRENT_DATE + INTERVAL '49 days', 10),
  ('social_media', '11. Execute Retargeting & Daily Follower Engagement Push', 'Actively engage in comments, reply to direct messages, send exclusive coupon codes to loyal customers, and drive final 60-day sales conversions.', 'Phase 4: Sales Push', 'todo', 'Favor', CURRENT_DATE + INTERVAL '56 days', 11),
  ('social_media', '12. Social Media 2-Month Campaign Milestone Review', 'Supervisory audit of 60-day follower growth, conversion metrics, affiliate payouts, and content quality signoff.', 'Phase 4: Supervision', 'todo', 'Mrs. Faith', CURRENT_DATE + INTERVAL '60 days', 12);
