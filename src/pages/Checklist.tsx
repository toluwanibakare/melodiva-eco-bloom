...
const DEFAULT_ITEMS: ChecklistItem[] = [
  ...
  // Social Media Tab - 2-Month Timeline (Weeks 1 - 8)
  {
    id: 'def-soc-1',
    tab: 'social_media',
    title: '1. Reactivate & Optimize Official Social Media Channels',
  ...
  },
  {
    id: 'def-soc-2',
    tab: 'social_media',
    title: '2. Formulate 60-Day Content Strategy & Editorial Calendar',
  ...
  },
  {
    id: 'def-soc-3',
    tab: 'social_media',
    title: '3. Design Social Media Graphic Templates & Branding Assets',
  ...
  },
  {
    id: 'def-soc-4',
    tab: 'social_media',
    title: '4. Configure WhatsApp Business Quick Replies & Link-in-Bio',
  ...
  },
  {
    id: 'def-soc-5',
    tab: 'social_media',
    title: '5. Publish Melodiva Brand Story & Ingredients Series',
  ...
  },
  {
    id: 'def-soc-6',
    tab: 'social_media',
    title: '6. Kickstart Affiliate Marketing Campaign Strategy & Collateral',
  ...
  },
  {
    id: 'def-soc-7',
    tab: 'social_media',
    title: '7. Launch Affiliate Recruitment Posts & DM Outreach',
  ...
  },
  {
    id: 'def-soc-8',
    tab: 'social_media',
    title: '8. Roll Out Black Soap & Kernel Oil Product Spotlights',
  ...
  },
  {
    id: 'def-soc-9',
    tab: 'social_media',
    title: '9. Launch Customer Testimonials & Before/After UGC Series',
  ...
  },
  {
    id: 'def-soc-10',
    tab: 'social_media',
    title: '10. Host 2-Month Campaign Anniversary Giveaway',
  ...
  },
  {
    id: 'def-soc-11',
    tab: 'social_media',
    title: '11. Execute Retargeting & Daily Follower Engagement Push',
  ...
  },
  {
    id: 'def-soc-12',
    tab: 'social_media',
    title: '12. Social Media 2-Month Campaign Milestone Review',
...
export default function Checklist() {
  ...
  useEffect(() => {
    ...
    if (currentVer !== 'v5_melody_pricing_order') {
      localStorage.removeItem('melodiva_local_checklist_items');
      localStorage.setItem('melodiva_checklist_version', 'v5_melody_pricing_order');
    }
    fetchItems();
  }, []);
